...
$arComponentParameters = [
    'PARAMETERS' => [
        ...
        'TEMPLATE_ROOT_USE_ELEMENTS' => [
            'PARENT' => 'BASE',
            'NAME' => 'Выводить на главной странице компонента список элементов (iblock.elements)',
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'Y'
        ],
        'TEMPLATE_ROOT_USE_SECTIONS' => [
            'PARENT' => 'BASE',
            'NAME' => 'Выводить на главной странице компонента список секций (iblock.sections)',
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'Y'
        ],
    ]
