    ...
    class JsonTextArea {
        ...
        constructor({ element, config = {} }) {
            ...
            if (config.copyElement) {
                ...
                const copyElement = document.querySelector(`[data-w-json-copy][data-w-json-id="${this.element.getAttribute("data-w-json-id")}"]`);
                if (copyElement) {
                    this.copy = new JsonCopy({
                        element: copyElement,
                        textarea: this,
            ...
            if (config.downloadElement) {
                ...
                const downloadElement = document.querySelector(`[data-w-json-download][data-w-json-id="${this.element.getAttribute("data-w-json-id")}"]`);
                if (downloadElement) {
                    this.download = new JsonDownload({
