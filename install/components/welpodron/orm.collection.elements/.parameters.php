...
$arFields['DETAIL_PAGE_URL'] = '[DETAIL_PAGE_URL] Ссылка на детальную страницу элемента';

// Props fields 

//! TODO: Добавить поддержку инфоблоков 2.0 где свойства хранятся в отдельной таблице 
...
$arComponentParameters = [
    ...
    'PARAMETERS' => [
        ...
        //! То лучше отключать (потенциально сильно так как создается несколько копий в зависимости от прав пользователя)
        'CACHE_GROUPS' => [
